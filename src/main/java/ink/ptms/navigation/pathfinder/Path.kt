...
/**
 * Navigation
 * ink.ptms.navigation.pathfinder.Path
 *
 * @author sky
 * @since 2021/2/21 10:07 下午
 */
@Suppress("CanBeParameter")
class Path(val nodes: MutableList<Node>, val target: Position, var reached: Boolean) {
